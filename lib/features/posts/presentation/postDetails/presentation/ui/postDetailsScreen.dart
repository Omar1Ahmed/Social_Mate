                                          ...
                                          childWidget: Column(
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                  ...
                                                  decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(info.screenWidth * 0.03))
                                              ),
                                              Container(
                          ...
                          childWidget: Column(
                            children: [
                              ...
                              Row(
                                children: [
                                  Container(
                                    margin: EdgeInsetsDirectional.only(start: info.screenWidth * 0.04),
                                      width: info.screenWidth * 0.05,
                                      height: info.screenHeight * 0.015,
                                      decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(info.screenWidth * 0.025))
                                  ),
                ...
                SliverList(
                    delegate: SliverChildBuilderDelegate(
                      childCount: postDetailsCubit.comments!.length == 0 ? 1 : postDetailsCubit.comments!.length,
                          (context, index) => postDetailsCubit.comments!.length >0 ? TweenAnimationWidget(
                        index: index,
                        deviceInfo: info,
                        child:SlideTransitionWidget(child: CommentCard(comment: postDetailsCubit.comments![index],info: info,)),
                      )
                      :
                              Container(
